% $Header$
% git remote set-url origin https://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@github.com/falistra/fondamentiMath.git
% git remote set-url origin https://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@github.com/falistra/fondamentiMath.git
...
\subtitle
{È davvero possibile che la strada più breve per la verità passi attraverso qualcosa di falso ? \cite[Stillwell]{Stillwell}} % (optional)


\author[F.~Zanasi, Matricola 154554] % (optional, use only with lots of authors)
{F.~Zanasi\inst{1} }
...
\subsection{Fermat}
\include{Fermat}
\include{Fermat-metodo}
\subsection{Cavalieri}
\include{Cavalieri-Torricelli}
