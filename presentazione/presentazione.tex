...
%\subtitle
%#{È la continuità storica. La matematica pura progredisce nella misura in cui i problemi noti vengono
%approfonditi in modo dettagliato in seguito all'elaborazione di nuovi metodi; nella misura in cui 
%si comprendono meglio gli antichi problemi, i nuovi si presentano spontaneamente.} 
